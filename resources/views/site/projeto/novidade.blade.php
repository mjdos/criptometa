@include('site.layouts.header')
        ...
        <div class="primary-content-area container content-padding">
            <div class="page-title">
                <h2><span class="gradient-text">Novidades</span> </h2>
            </div>
                ...
                <!-- contact form -->
                    <form class="cryptoki-form validation" id="contact-form" method="POST" action="forms/submit-mail.php" novalidate>
                        ...
                        <div class="form-field comment-area">
                            <label for="message">Descreva a novidade</label>
                ...
                <aside>
                    <div class="widgets-list">
                        <div class="widget widget-contact">
                            <div class="widget-title h5">Novidades</div>
                            <div class="widget-body">
                                </div>
                                <div class="email-owner">
                                    Novidades incentivam doadores a participar do projeto.
                                </div>
                            </div>
                        </div>
                        <br>
                        ...
                        <div class="widget widget-social">
                            <div class="email-owner">
                                <p>Novidades são adicionadas ao projeto para que insentive as pessoas a apoiar o projeto, pois deixam ele cientes da trajetória do projeto. </p>
                                <p>Nessa tela voce poderá adicinar tais Novidades   </p>
                            </div>
                            </div>
                        </div>
                    </div>
