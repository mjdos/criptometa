                ...
                <div class="product-title-section">
                    ...
                    <div class="product-subtitle">
                        <div class="product-author">
                            ...
                            </span>{{$projetos->first()->autor->name}}
                        </div>
                    </div>
                </div>
                <div class="product-image">
                    <img src="{{ url($projetos->first()->imagem )}}" alt="Product Image">
                </div>
                    ...
                    <div class="product-purchase-info">
                        <form class="cryptoki-form" id="purchase-form">
                            <div class="product-price">
                                <div class="price">$ {{$projetos->first()->valor}} </div>
                    ...
                    <div class="product-details">
                        ...
                        <div class="product-details-wrapper">
                            ...
                            <ul class="details-value">
                                <li>{{date('d/m/Y', strtotime($projetos->first()->created_at))}}</li>
