@include('site.layouts.header')
    ...
    <div>
        <div class=" container-1300 section-padding-medium">
            <div class="bc-info">
                <div class="bc-heading" align="center">
                    <div class="bc-heading-subtitle">Quem Somos</div>
                    <div class="bc-heading-title"><table><td><img src="img/logo.png" width="100" alt=""></td><td>Cripto<span class="gradient-text">Meta</td></tr></table></span>
                    </div>
                </div><br><br>
                <div class="bc-description">Bem-vindo ao Criptometa, a inovadora plataforma de crowdfunding que revoluciona o financiamento de projetos tecnológicos. Com um modelo único baseado em metas claras e entrega comprovada, garantimos uma experiência segura e transparente tanto para criadores quanto para investidores.
<br><br>
...
<br><br>
                ...
                <div class="bc-button" align="center"><a class="btn btn-wide btn-dark" href="{{route('site.login')}}">Comece a arrecadar!</a>
                </div>
            </div>
