...
<head>
    ...
    <title>Painel de Controle - CriptoMeta</title>
    ...
    <div class="main-wrapper">
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center" style='background-image: url("assets/img/fundo.webp");background-repeat: repeat-x;'>
            <div class="auth-box">
                <div id="loginform">
                    <div class="logo">
                        <span><img src="{{ url ('assets/img/favicon02.png') }}" width="200px" /></span>
                        @if($errors->all())
                    ...
                    <div class="row">
                        <div class="col-12">
                            <form class="form-horizontal mt-3" method="POST" action="{{ route('login_gestao') }}">
                                @csrf
