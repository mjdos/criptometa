                ...
                el.addEventListener('submit', (e) => {
                    ...
                    .then(data => {
                        ...
                        try {
                            ...
                            if( data_el.status !== null && data_el.status == 0 && !el.classList.contains("validation")) {
                                ...
                                let p = document.createElement("p");
                                p.innerHTML = (!el.classList.contains("validation"))?'Some problem occurred, please try again.': "Fill out all the required fields.";
                                p.classList = 'cryptoki-form-error';
                                e.target.append(p);
                            }
                        } catch (e) {
